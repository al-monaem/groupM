...
const Error = () => {
    return (
        <div className='flex justify-center mt-24 w-screen h-screen p-10'>
            <div className='flex flex-col items-center space-y-5'>
                <p className='text-2xl font-semibold text-gray-400'>Page Not Found :{"("}</p>
                <p className='text-center tracking-wider'>Oops! 😖 The requested URL was not found on this server.</p>
                <Link
                    to={"/"}
